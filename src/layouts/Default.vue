  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><g-image src="../../static/wesecureweb-text-logo.png" class="w-40" alt="logo" /></g-link>
          <g-link v-else to="/"><g-image src="../../static/wesecureweb-text-logo.png" class="w-40" alt="logo" /></g-link>
        </div>
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:wesecureweb@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/joahn3/" target="_blank" class="text-white hover:text-gray-400">
